    ...
    pgAdmin.Browser.Nodes['role'] = pgAdmin.Browser.Node.extend({
      ...
      model: pgAdmin.Browser.Node.Model.extend({
        ...
        schema: [{
          ...
          options: {
            'onText': gettext('User'),
            'offText': gettext('Role'),
            width: '65',
          },
        },
        {
          id: 'rolname', label: gettext('Name'), type: 'text',
          readonly: 'readonly', mode: ['edit', 'create', 'properties'],
        },{
          id: 'login_type', label: gettext('Type'), type: 'text',
          readonly: 'readonly', mode: ['properties'],
        },{
        ...
        */
        ...
        // },
          ...
          schema: [{
            ...
            id: 'host_express', label: gettext('Value'), type: 'text',
            readonly: 'readonly', mode: ['edit', 'create'],
            group: gettext('Host Info'),
            cell: 'string',
          }],
          ...
          model: pgBrowser.Node.VariableModel.extend({keys:['name']}),
          ...
          group: gettext('Security'), mode: ['edit' ],
      ...
      create_user: function(m) {
        return m.get('is_user');
      },
      create_role: function(m) {
