...
var webpackShimConfig = {
  ...
  resolveAlias: {
    ...
    'pgadmin.node.datatype': path.join(__dirname, './pgadmin/browser/server_groups/servers/datatypes/static/js/datatype'),
    ...
    'pgadmin.node.format': path.join(__dirname, './pgadmin/browser/server_groups/servers/formats/static/js/format'),
    ...
    'pgadmin.node.sn_function': path.join(__dirname, './pgadmin/browser/server_groups/servers/functions/static/js/function'),
